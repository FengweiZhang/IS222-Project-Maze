...
#define GPIO_ReadInputDataBit(GPIOx, PIN)	HAL_GPIO_ReadPin(GPIOx, PIN)

/******************************* 内部函数 ***************************/

#define	XPT2046_CS_ENABLE()		GPIO_ResetBits ( XPT2046_CS_GPIO_Port, XPT2046_CS_Pin )
#define	XPT2046_CS_DISABLE()	GPIO_SetBits ( XPT2046_CS_GPIO_Port, XPT2046_CS_Pin )

#define	XPT2046_CLK_HIGH()	GPIO_SetBits ( XPT2046_CLK_GPIO_Port, XPT2046_CLK_Pin )
#define	XPT2046_CLK_LOW()	GPIO_ResetBits ( XPT2046_CLK_GPIO_Port, XPT2046_CLK_Pin )

#define	XPT2046_MOSI_1()	GPIO_SetBits ( XPT2046_MOSI_GPIO_Port, XPT2046_MOSI_Pin )
#define	XPT2046_MOSI_0()    GPIO_ResetBits ( XPT2046_MOSI_GPIO_Port, XPT2046_MOSI_Pin )

#define	XPT2046_MISO()	HAL_GPIO_ReadPin ( XPT2046_MISO_GPIO_Port, XPT2046_MISO_Pin )

//触屏信号有效电平
#define             XPT2046_PENIRQ_ActiveLevel                     0
#define             XPT2046_PENIRQ_Read()                          GPIO_ReadInputDataBit ( XPT2046_PENIRQ_GPIO_Port, XPT2046_PENIRQ_Pin )
